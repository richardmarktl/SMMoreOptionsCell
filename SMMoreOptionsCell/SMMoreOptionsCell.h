...
// This scrollViewOptionsView contains per default the following 2 buttons, feel free to set your own options view. The
// options view is always set to hidden if not visible through the scroll behaviour.
